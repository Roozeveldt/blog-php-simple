                        ...
                        <li class="header__profile">
                            <a class="header__profile-link" href="#">
                                <div class="header__avatar-wrapper">
                                    <img class="header__profile-avatar" src="uploads/userpic/<?= $_SESSION['user']['userpic']; ?>" alt="Аватар профиля">
                                </div>
                                    ...
                                    <ul class="header__profile-nav">
                                        ...
                                        <li class="header__profile-nav-item">
                                            <a class="header__profile-nav-link" href="messages.php">
                                                <span class="header__profile-nav-text">
                                                    Сообщения
                                                    <i class="header__profile-indicator"><?= $count_new_messages; ?></i>
                                                </span>
                                            </a>
                                        </li>
                                        <li class="header__profile-nav-item">
                ...
                <?php else : ?>
                    <ul class="header__user-nav">
                        <li class="header__authorization">
                            <a class="header__user-button <?= (basename($_SERVER['PHP_SELF']) == 'login.php') ? 'header__user-button--active' : ''; ?> header__authorization-button button" href="login.php">Вход</a>
                        </li>
                        <li>
                            <a class="header__user-button <?= (basename($_SERVER['PHP_SELF']) == 'registration.php') ? 'header__user-button--active' : ''; ?> header__register-button button" href="registration.php">Регистрация</a>
                        </li>
                    </ul>
                <?php endif; ?>
            </nav>
