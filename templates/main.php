                ...
                <form class="authorization__form form" action="" method="post">
                    <div class="authorization__input-wrapper form__input-wrapper <?= isset($errors['login']) ? "form__input-section--error" : ''; ?>">
                        ...
                        <?php if (isset($errors['login'])) : ?>
                            ...
                            <span class="form__error-label form__error-label--login" style="background: #fff; padding: 5px 15px; font-size: 20px;"><?= $errors['login'] ? $errors['login'] : ''; ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="authorization__input-wrapper form__input-wrapper <?= isset($errors['password']) ? "form__input-section--error" : ''; ?>">
                        ...
                        <?php if (isset($errors['password'])) : ?>
                            ...
                            <span class="form__error-label" style="background: #fff; padding: 5px 15px; font-size: 20px;"><?= $errors['password'] ? $errors['password'] : ''; ?></span>
                        <?php endif; ?>
                    </div>
