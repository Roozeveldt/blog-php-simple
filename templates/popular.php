                        ...
                        <div class="post__main">
                                    ...
                                    <a class="post-link__external" href="<?= h($post['content']); ?>" title="Перейти по ссылке" target="_blank">
                                        <div class="post-link__info-wrapper">
                                            <div class="post-link__icon-wrapper">
                                                <img src="https://www.google.com/s2/favicons?domain=<?= h($post['content']); ?>" alt="Иконка">
                                            </div>
                            ...
                            <?php elseif ($post['type'] == "photo") : ?>
                                <div class="post-photo__image-wrapper">
                                    <img src="uploads/<?= h($post['content']); ?>" alt="<?= h($post['heading']); ?>" width="360" height="240">
                                </div>
                            ...
                            <?php elseif ($post['type'] == "video") : ?>
                                <div class="post-video__block">
                                    <div class="post-video__preview">
                                        <img src="<?= embed_youtube_cover(h($post['content'])); ?>" alt="<?= h($post['heading']); ?>" width="360" height="240">
                                    </div>
                            ...
                            <?php elseif ($post['type'] == "text") : ?>
                                <?= sliceText(h($post['content']), $post['id'], 200); ?>
                            <?php endif; ?>
                        </div>
                        <footer class="post__footer">
                            <div class="post__author">
                                <a class="post__author-link" href="profile.php?id=<?= $post['user_id']; ?>" title="<?= h($post['login']); ?>">
                                    <div class="post__avatar-wrapper">
                                        <img class="post__author-avatar" src="uploads/userpic/<?= h($post['userpic']); ?>" width="40" height="40" alt="Аватар пользователя <?= h($post['login']); ?>">
                                    </div>
                                    <div class="post__info">
                                        <b class="post__author-name"><?= h($post['login']); ?></b>
